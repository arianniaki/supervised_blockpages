...
This is the main class for running the supervised learning algorithm for the Images
"""
...
train_path = 'multi/train/'
test_path = 'multi/test/'
...
data_test = datasets.read_test_set_labeled(test_path, img_size, classes)
...
def optimize(num_iterations):
    ...
    for i in range(total_iterations,
        ...
        # print ('in optimize total iteration', i, total_iterations, str(int(data.train.num_examples / batch_size)), str(int(data.train.num_examples)), str(batch_size))
...
def print_test_accuracy(show_example_errors=False):
    ...
    while i < num_test:
        ...
        feed_dict = {x_true: images, y_true: labels,dropout_param: 1.0}
...
optimize(num_iterations=4599)  # We already performed 1 iteration above.
